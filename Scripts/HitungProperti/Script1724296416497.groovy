...
WebUI.click(findTestObject('Object Repository/Page_Hitung Harga Properti Maksimal  BTN Pr_37bba6/h3_Rp 3.000.000'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Hitung Harga Properti Maksimal  BTN Pr_37bba6/h3_Rp 3.000.000'), 
    Input_Hasil)
